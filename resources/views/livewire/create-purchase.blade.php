<div class="flex">
    <div>
        <div class="flex h-[30px]">
            ...
            <x-button class="flex text-sm border border-green-500 hover:bg-green-500 w-[30px] mx-1">+</x-button>
        </div>
        ...
        <x-button class="flex text-sm border border-green-500 hover:bg-green-500 mx-1" wire:click="submit">Save Purchase</x-button>
    </div>
